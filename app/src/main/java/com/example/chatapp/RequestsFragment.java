...
public class RequestsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, RequestsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, RequestsViewHolder>(options) {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot)
                                            {
                                                if (dataSnapshot.hasChild("image"))
                                                {
                                                    ...
                                                    if(isAdded()) {
                                                        Glide.with(getContext().getApplicationContext()).setDefaultRequestOptions(requestOptions).load(requestProfileImage).into(holder.profileImage);
                                                    }
                                    ...
                                    else if (type.equals("sent"))
                                    {
                                        ...
                                        request_sent_btn.setText("Cancel it!");
                    ...
                    {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.users_requests_display_layout, viewGroup, false);
    ...
    public static class RequestsViewHolder extends RecyclerView.ViewHolder {
        ...
        public RequestsViewHolder(@NonNull View itemView) {
            ...
            userName = itemView.findViewById(R.id.user_request_profile_name);
            userStatus = itemView.findViewById(R.id.user_request_status);
            profileImage = itemView.findViewById(R.id.users_request_profile_image);
